...
- (void)drawRect:(CGRect)rect {
  ...
  if (displayedMessage == nil) {
    self.displayedMessage = NSLocalizedStringWithDefaultValue(@"OverlayView displayed message", nil, [NSBundle mainBundle], @"큐알코드를 읽을 수 있게 사각형 안에 위치해 주세요", @"큐알코드를 읽을 수 있게 사각형 안에 위치해 주세요");
  }
